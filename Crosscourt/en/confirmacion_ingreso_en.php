...
{
	?> <h1 class="registro"> Login Successful! </h1> <br>
	   <center> <button class="button login" onclick="location.href='index_es_admin_en.php';"> Navigate as Administrator </button>
	   </center>
	<?php
}
else
{
	?> <h1 class="registro"> Failed Login! Try Again </h1> 
	<?php
}
	?>
</html>