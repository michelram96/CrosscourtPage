...
<h2 class="news" id="c"> Murray Advances in 5 Sets </h2></center>
<h2 class="news" id="d" style="opacity:0"> One step at a time paramount<br> for Novak Djokovic, Rafael Nadal</h2></center>
</form>
</div>
...
<button class="news" onclick="transition2()" ondblclick="location.href='andy_rg_news_admin_en.html';"> </button>
<div class="divider"/>
<button class="news" onclick="transition()"ondblclick="location.href='rafa_rg_news_admin_en.html';"> </button> 
</div>
